...
const FoodDelivered = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${API_URL}/api/orders-delivered/`)
            .then(res => res.json())
            .then(data => {
                setOrders(data)
                setAllOrders(data)
        ...
        <AdminLayout>
            <div className='container'>
                <h3 className='text-center text-primary mb-4'>
                    <i className='fas fa-list-alt me-1'></i>Detail Order Delivered
                </h3>
                ...
                <div className='mb-3 d-flex justify-content-between'>
                    ...
                    {/* CSV FILE */}
                    <CSVLink filename={'order-Delivered-list.csv'} data={orders} className='btn btn-outline-success '>
