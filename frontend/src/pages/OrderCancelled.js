...
const OrderCancelled = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${API_URL}/api/order-cancelled/`)
            .then(res => res.json())
            .then(data => {
                setOrders(data)
                setAllOrders(data)
        ...
        <AdminLayout>
            <div className='container'>
                ...
                <h5 className='text-end text-muted'>
                    <i className='fas fa-database me-1'></i>Total Order Cancelled
                ...
                <div className='mb-3 d-flex justify-content-between'>
                    ...
                    {/* CSV FILE */}
                    <CSVLink filename={'order-cancelled-list.csv'} data={orders} className='btn btn-outline-success '>
