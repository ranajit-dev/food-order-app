        ...
        <AdminLayout>
            <div className='container'>
                <h3 className='text-center text-primary mb-4'>
                    <i className='fas fa-list-alt me-1'></i>Detail of All Order Received
                </h3>
                <h5 className='text-end text-muted'>
                    <i className='fas fa-database me-1'></i>Total Order Received
                ...
                <div className='mb-3 d-flex justify-content-between'>
                    ...
                    {/* CSV FILE */}
                    <CSVLink filename={'all-orders-list.csv'} data={orders} className='btn btn-outline-success '>
