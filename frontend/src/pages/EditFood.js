                        ...
                        <form onSubmit={handleSubmit} encType='multipart/form-data'>
                            ...
                            <div className='mb-3 '>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-6'>
                                        {formData.image && (
                                            <img src={formData.image instanceof File ? URL.createObjectURL(formData.image) : formData.image} alt='food-img' className='img-fluid' style={{ maxHeight: '100px', border: '1px solid red', borderRadius: '8px', padding: '4px', maxWidth: '153px' }} />
                                        )}
                                    </div>
                                </div>
                            </div>
